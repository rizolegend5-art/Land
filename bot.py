...
# │  BOT TOKEN  add karo.   ││
# └──────────────────────────────────────────────────────────────┘
BOT_TOKEN_HARDCODED = "8977490833:AAFt77EEGjAIa2fkZoRcU0_13zOUoFLzdYQ"   # ← ADD BOT TOKEN
TOKEN = (
...
try:
    OWNER_ID = int(os.environ.get("OWNER_ID", "8265653257"))
...
BRAND       = "𝐑𝐈𝐙𝐎 𝐇𝐀𝐂𝐊𝐄𝐑 𖣘 нoѕтιηg ΒOT"
BRAND_VER   = "v6.9"
BRAND_TAG   = f"{BRAND} {BRAND_VER}"
SUPPORT_USR = "@rizohacker1"
UPDATE_CH   = "https://t.me/srkingteam001"
...
_HELP_PAGES = {
    "main": {
        "title": "📚 Help Centre",
        "text": (
            "Welcome to <b>𝗟𝗘𝗔𝗗𝗘𝗥 𝗦𝗛𝗔𝗗𝗠𝗔𝗡 𖣘 Hosting Bot</b>\n\n"
            "<b>Quick Start</b>\n"
...
def render_referral(call: types.CallbackQuery) -> None:
    ...
    try:
        ...
        link = f"@rizo_x_waju_hosting_bot?start={uid}"
    cap = (
        f"<b>{G['users']} {sc('Referral')}</b>\n"
        f"{G['div_eq']}\n"
        f"{bullet('Your link', link)}\n"
